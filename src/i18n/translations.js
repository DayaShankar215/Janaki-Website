...
export const translations = {
  en: {
    ...
    contact: {
      ...
      mapComingSoon: 'Map location coming soon.',
      updateNote1: 'Update address & location anytime in',
      adminPanel: 'the admin panel',
      updateNote2: '— see also',
      admissionInfo: 'admission info',
      updateNote3: 'before visiting.',
    },
  ...
  ne: {
    ...
    about: {
      ...
      heroImageAlt: 'उपकरण प्रदर्शन गर्दै प्राविधिक प्रशिक्षक',
      badgeSkills: 'सीप +',
      badgeOpportunity: 'अवसर',
      storyEyebrow: 'हामी को हौं',
      storyIntro: 'हातले गर्ने सीप विकासमा समर्पित प्राविधिक तथा व्यावसायिक तालिम संस्था हो।',
      storyTrades:
        'हामी विद्युत कार्य, प्लम्बिङ, निर्माण, वेल्डिङ, कम्प्युटर सीप, होटल व्यवस्थापन, कृषि र सिलाइजस्ता सीपहरूमा तालिम प्रदान गर्छौं।',
      storyP2:
        'हरेक कार्यक्रम कार्यशाला अभ्यासमा आधारित हुन्छ — तालिमार्थीहरूले अनुभवी प्रशिक्षकको मार्गदर्शनमा आफ्नो सीपका औजार, सामग्री र उपकरणहरू प्रयोग गर्छन्। लक्ष्य सरल छ: काम गर्न सक्ने स्नातक, केवल वर्णन गर्ने होइन।',
      recognitionTitle: 'मान्यता तथा सम्बद्धता',
      directionEyebrow: 'दिशा',
      missionVisionTitle: 'हाम्रो लक्ष्य तथा सपना',
      ourMission: 'हाम्रो लक्ष्य',
      ourVision: 'हाम्रो सपना',
      missionItem1: 'व्यावहारिक, रोजगारमुखी प्राविधिक तालिम प्रदान गर्ने',
      missionItem2: 'प्राविधिक क्षमता र कार्यस्थल अनुशासन विकास गर्ने',
      missionItem3: 'करियर विकास र स्वरोजगारका मार्गहरूलाई सहयोग गर्ने',
      missionItem4: 'सबै विद्यार्थीका लागि गुणस्तरीय व्यावसायिक शिक्षा पहुँचयोग्य बनाउने',
      visionP1:
        'विश्वसनीय व्यावसायिक उत्कृष्टता केन्द्र बन्ने — आफ्ना परिवार, समुदाय र सेवा गर्ने उद्योगलाई सबल बनाउने सीपयुक्त, सक्षम जनशक्ति उत्पादन गर्ने।',
      visionP2:
        'हामी हरेक स्नातक प्रमाणपत्रभन्दा बढीका साथ — गर्व र आत्मविश्वाससहित अभ्यास गर्न सक्ने सीप लिएर जाने कल्पना गर्छौं।',
    },
